...
public class Session {
  ...
  /**
   * @return the raw <code>HttpSession</code> object handed in by the servlet
   *         container.
   */
  ...
  public Set<String> attributes() {
    return new TreeSet<String>(Collections.list(session.getAttributeNames()));
  }

  /**
   * @return the time when this session was created, measured in milliseconds
  ...
  /**
   * @return the maximum time interval, in seconds, that the container will keep
